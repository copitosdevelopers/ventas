<template>
  <div class="card mt-2" >
              <div class="card-header">
                <h3 class="card-title">Listado de proveedores 
                    </h3>
                ...
                <table class="table table-sm">
                  ...
                  <tbody>
                    <tr v-for="(proveedor, index) in proveedores " :key="proveedor.id">
                      ...
                      <td>
                          <span v-if="proveedor.estado==1" class="badge bg-success">Activo</span>
                          <span v-else class="badge bg-danger">Inactivo</span>
                      </td>
                      <td>
                            <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#modal-lg" @click="abrirModal('proveedor','actualizar',proveedor)">
                              Editar <i class="fas fa-edit"></i>
                            </button>
                            <button v-if="proveedor.estado==1" type="button" class="btn btn-outline-danger btn-sm" @click="desactivarProveedor(proveedor.id)">
                              Desactivar  <i class="fas fa-times"></i> 
                            </button>
                            <button v-else type="button" class="btn btn-outline-success btn-sm" @click="activarProveedor(proveedor.id)">
